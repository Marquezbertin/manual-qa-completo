...
- Scripts executáveis e verificados em 8 módulos:
  - `03/scripts/estimate.py` — estimativa PERT
  - `04/scripts/triage.py` — severidade × prioridade (SLA)
  - `05/scripts/` — suíte de login UI (Playwright + Page Object)
  - `06/scripts/` — suíte de API REST local (requests + jsonschema)
  - `07/scripts/percentile.py` — cálculo de p95/p99
  - `08/scripts/quality_gate.py` — quality gates
  - `09/scripts/kpi.py` — KPIs de qualidade
  - `11/scripts/secret_scan.py` — secret scanning (OWASP)
