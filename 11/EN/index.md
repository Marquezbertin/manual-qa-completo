...
The script `11/scripts/secret_scan.py` detects obvious secrets (AWS keys, private keys, passwords) via regex — no dependencies:
...
Run: `python 11/scripts/secret_scan.py`
