...
O script `11/scripts/secret_scan.py` detecta segredos óbvios (chaves AWS, chaves privadas, senhas) via regex — sem dependências:
...
Execute: `python 11/scripts/secret_scan.py`
